...
@section('content')
<form id="form_add" action="{{ route('horarios_add') }}" method="post">
  {{ csrf_field() }}
                              ...
                              <td>
                                <table border="0" cellspacing="1" cellpadding="0" bordercolor="#999999" width="100%">
                                  ...
                                  <tr>
                                    ...
                                    <td bgcolor="#CCCCCC"><input name="f_inicio" type="text" readonly="readonly" class="tcal" id="f_inicio"  style="width:215px; background-color:#FFF; font-weight:bold;" /></td>
                                  </tr>
                                  <tr>
                                    <td class="stylish_graverx_b"><img src="{{ asset('img/rde3.png') }}" alt="" width="11" height="13" /></td>
                                    <td bgcolor="#CCCCCC" class="sub_title">Fecha Fin</td>
                                    <td bgcolor="#CCCCCC"><input name="f_fin" type="text" readonly="readonly" class="tcal" id="f_fin"  style="width:215px; background-color:#FFF; font-weight:bold;" /></td>
                                  </tr>
                                  <tr>
                                    <td class="stylish_graverx_b"><img src="{{ asset('img/rde3.png') }}" alt="" width="11" height="13" /></td>
                                    ...
                                    <td bgcolor="#CCCCCC">
                                      <select id="id_relator" name="id_relator" style="width: 100%;">
                                        ...
                                        @foreach ($relatores as $r)
                                          <option value="{{ $r->id_relator }}">{{ $r->nombre }} {{ $r->a_paterno }} {{$r->a_materno }}</option>
                                        @endforeach
                                      </select> 
                                    </td>
                                  </tr>
                                  <tr>
                                    ...
                                    <td bgcolor="#CCCCCC"><input type="text" name="nombre" id="nombre" readonly style="width:236px; background-color:#FFF;"></td>
                                  </tr>
                                </table>
                              </td>
                              ...
                              <td valign="top" width="350px">
                                <table border="0" cellspacing="1" cellpadding="0" bordercolor="#999999" width="100%">
                                  <tr>
                                    ...
                                    <td bgcolor="#CCCCCC">
                                      <select id="id_curso_horario" name="id_curso_horario" style="width: 237px;">
                                        <option value="-" selected>-</option>
                                      </select> 
                                    </td>
                                  </tr>
                                  <tr>
                                    ...
                                    <td bgcolor="#CCCCCC">
                                      <input type="hidden" name="hf_h_inicio" id="hf_h_inicio">
                                  ...
                                  <tr>
                                    ...
                                    <td bgcolor="#CCCCCC">
                                      <input type="hidden" name="hf_h_fin" id="hf_h_fin">
                                      <table width="100%">
                                        <tr>
  ...
  <script>
    ...
    $(document).ready(function() {
      ...
      $('#btn_add').click(function(e){
        e.preventDefault();
        valida = "";
        id = $('#id_curso_horario').val() + $('#h_inicio').val() + $('#h_fin').val();
        ...
        if (valida == "")
        {
          ...
          row = '<tr id="tr_horarios_' + rowCount + '">' +
            ...
            '<td valign="top" bgcolor="#FFFFFF" class="prsnal_mini2">' + $('#id_curso_horario').val() + '<input type="hidden" value="' + id +'" /></td>' +
    ...
    function seleccionar_sala(id_sala, nombre, btn)
    {
      ...
      $.post(url, form.serialize() + "&id_sala=" + id_sala, function(result){
        ...
        $('#id_curso_horario').empty();
        $('#id_curso_horario').append('<option value="-">-</option>');
        $.each(result.dias, function(index, dia){
          $('#id_curso_horario').append('<option value="' + dia + '">' + dia + '</option>');
        });
