                  ...
                  <td width="65%" height="10" align="left" valign="top" bgcolor="#999999">
                    <table width="100%" border="0" cellspacing="2" cellpadding="0" bordercolor="#999999">
                      <tr>
                        ...
                        <td bgcolor="#CCCCCC"><input name="desc_curso" type="text" class="sub_title" id="desc_curso"  style="width:220px;" maxlength="180" value="" /></td>
                      </tr>
                      <tr>
                        <td class="stylish_graverx_b"><img src="{{ asset('img/rde3.png') }}" alt="" width="11" height="13" /></td>
                        <td height="23" bgcolor="#BBBBBB" class="stylish_graverx_b">Ponderación Mínima</td>
                        <td bgcolor="#CCCCCC"><input name="ponderacion_min" type="text" class="sub_title" id="ponderacion_min"  style="width:220px;" maxlength="180" onkeypress="return validarn(event)" /></td>
                      </tr>
                      <tr>
                        <td class="stylish_graverx_b"><img src="{{ asset('img/rde3.png') }}" alt="" width="11" height="13" /></td>
                        <td height="23" bgcolor="#BBBBBB" class="stylish_graverx_b">Ponderación Máxima</td>
                        <td bgcolor="#CCCCCC"><input name="ponderacion_max" type="text" class="sub_title" id="ponderacion_max"  style="width:220px;" maxlength="180" onkeypress="return validarn(event)" /></td>
                      </tr>
                      <tr>
                        <td class="stylish_graverx_b"><img src="{{ asset('img/rde3.png') }}" alt="" width="11" height="13" /></td>
                        ...
                        <td bgcolor="#CCCCCC"><select name="id_tipo_curso" class="sub_title" id="id_tipo_curso" style="width:220px;" >
                          ...
                          @foreach ($tipo_cursos as $tc)
                            <option value="{{ $tc->id_tipo_curso }}">{{ $tc->desc_tipo_curso }}</option>
                          @endforeach
                        </select></td>
                      </tr>
                      <tr>
                        ...
                        <td bgcolor="#CCCCCC"><textarea id="contenido" name="contenido" class="sub_title" style="height: 100px; width: 95%;"></textarea></td>
                      </tr>
                      <tr>
                        ...
                        <td height="23" bgcolor="#BBBBBB" class="stylish_graverx_b">
                          ...
                          <input name="btn_save" type="submit" class="main_fitz" id="btn_save" value="Crear Curso" />
                        </td>
                      </tr>
                    </table>
                  </td>
